...
app_description = "For Learning Customization"
app_email = "mukesh@raindropinc.io"
app_license = "MIT"
...
doctype_js = {"Out Of Office Slip" : "public/js/out_of_office.js"}
...
doc_events = {
  	"Out Of Office Slip": {
		"on_update": "raindrop.Custom_Code.out_of_office.on_update"
